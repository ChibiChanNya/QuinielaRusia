<template>
  <div id="matches">
    ...
    <div class="header">
      <a href="https://bindiva.com" style="top:3px" target="_blank"><img
        src="../assets/Interna/logo-bindiva-blanco.png"></a>
    ...
    <h1 style="margin:50px; font-size: 3em;"> QUINIELA DE {{display_name}}</h1>

    <div style="margin-bottom: 3em">
      <router-link to="/leaderboard"><h1 class="russia-badge rules" @click="showModal = true"><span>Ver Tabla de Resultados</span>
      </h1></router-link>
    </div>
    ...
    <div class="offset-md-4" style="margin-top:50px;margin-bottom:50px">
      <div class="v-select-block">
        <label class=" col-md-4" for="first-place">Campeón:</label>
        <vSelect id="first-place" v-model="specials.selected_1st" :options="team_names" disabled="disabled"></vSelect>
      </div>
      <div class="v-select-block">
        <label class="col-md-4 " for="second-place">Subcampeón:</label>
        <vSelect id="second-place" v-model="specials.selected_2nd" :options="team_names" disabled="disabled"></vSelect>
      </div>
      <div class="v-select-block">
        <label class="col-md-4" for="third-place">Tercer Lugar:</label>
        <vSelect id="third-place" v-model="specials.selected_3rd" :options="team_names" disabled="disabled"></vSelect>
      </div>
      <div class="v-select-block">
        <label class="col-md-4" for="fourth-place">Cuarto Lugar:</label>
        <vSelect id="fourth-place" v-model="specials.selected_4th" :options="team_names" disabled="disabled"></vSelect>
      </div>
      <div class="v-select-block">
        <label class="col-md-4" for="champion-goaler">Campeón Goleador:</label>
        <vSelect id="champion-goaler" v-model="specials.selected_goaler" :options="players" disabled="disabled"></vSelect>
      </div>
    </div>
...
<script>
  import {getMatches, getTeams, getPredictionsUser} from '../../utils/matches-api';
  ...
  export default {
    ...
    async created() {
      ...
      getPredictionsUser(this.$route.params.id).then((predictions) => {
        console.log("PRED", predictions);
        console.log(this.$route);
        this.display_name = predictions.name;
        document.title = "Quiniela de "+ predictions.name;
