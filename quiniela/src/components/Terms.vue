<template>
  <div >
    ...
    <div id="privacy">
      <h1>TÉRMINOS Y CONDICIONES DE USO DE QUINIELASPORTS.COM</h1>
      ...
      <h2>4. MODIFICACIONES A LOS T y C.</h2>
      ...
      <ul>
        <li>Se prohíben las comunicaciones comerciales no autorizadas (como spam) en QUINIELASPORTS.COM.</li>
        <li>No puedes acceder a cuentas ajenas a la propia.</li>
        <li>No molestarás, intimidarás o acosarás a ningún usuario dentro de la plataforma.</li>
        <li>No utilizarás QUINIELASPORTS.COM para actos ilícitos, engañosos, malintencionados, fraudulentos, actos de competencia desleal, generación de enriquecimiento personal o en general aquellos actos que puedan entenderse como contrarios a la moral y las buenas costumbres.</li>
        <li>Se prohíben publicaciones con lenguaje que incite al odio, violencia racial, resulte intimidatorio, contenido pornográfico, incite a la violencia o contenga desnudos o violencia gráfica, consumo y uso de sustancias ilícitas.</li>
        <li>No realizarás ninguna acción que pudiera inhabilitar, sobrecargar o afectar al funcionamiento correcto de QUINIELASPORTS.COM o a su aspecto, como un ataque de denegación de servicio o la alteración de la presentación de páginas u otras funciones de QUINIELASPORTS.COM.</li>
        <li>No tienes derecho a transferir tu cuenta como miembro a un tercero.</li>
        <li>En caso de que una misma persona quiera llenar más de una quiniela, este podrá inscribirse generando una cuenta por un correo electrónico validado.</li>
      </ul>

      <h2>7. ELIMINACIÓN, BLOQUEO Y ADVERTENCIAS.</h2>
      <p>El compromiso con nuestros clientes en QUINIELASPORTS.COM es total, con la finalidad de mantener la calidad y uso de la plataforma es requisito respetar los lineamientos y políticas de uso descritos en el presente documento. Si consideramos que el contenido, transmisión y/o uso de los servicios viola estos términos, QUINIELASPORTS.COM podrá limitar o eliminar el contenido de la información enviada a la plataforma de forma parcial o total, derivando en una advertencia o bloqueo parcial o total de la cuenta que envíe la información, por ello es de suma importancia el uso correcto y resguardo de acceso a tu perfil en la plataforma QUINIELASPORTS.COM.</p>

      <h2>8. SERVICIOS.</h2>
      <p>Quiniela Sports, se reserva el derecho de modificar, suspender, periódica o en cualquier momento, ya sea de forma permanente o temporal, funciones y características de la plataforma de QUINIELASPORTS.COM.</p>

      <h2>9. DISPONIBILIDAD.</h2>
      <p>En Quiniela Sports estamos comprometidos con nuestros clientes, trabajamos de forma constante para que nuestra plataforma siempre se encuentre disponible y en línea para que nuestros suscriptores tengan el acceso correcto a nuestros servicios, sin embargo hay factores externos a la plataforma web de QUINIELASPORTS.COM y, en el caso poco probable que una situación propia o ajena a nuestra plataforma tenga como resultado la no disponibilidad de acceso a nuestros suscriptores, de inmediato trabajaremos de forma independiente y/o en conjunto con nuestros asociados y proveedores para resolver dichos inconvenientes.</p>
      ...
      <p>El pago que se realiza a Quiniela Sports  se realizara en una solo exhibición por única ocasión.</p>
      ...
      <p>Eres responsable de todo el contenido que transmites a través de Quiniela Sports, por ejemplo, textos, datos, fotos o series de vídeos (en adelante "contenido"). Este contenido no es inspeccionado por Quiniela Sports  antes de ser colocado en el sitio web y no representa la opinión de Quiniela Sports, ni de ninguno de sus colaboradores. Quiniela Sports se excluye expresamente de toda responsabilidad de este contenido. El contenido en este sentido se refiere no al contenido propio de Quiniela Sports, sino al contenido de terceros usuarios de Quiniela Sports.</p>
      <p>Mediante la transmisión de contenido, garantizas que posees los derechos de uso requeridos para la publicación de este contenido en Internet. Además, garantizas y asegura que el contenido que transmite no está sujeto a los derechos de terceros.</p>
      <p>Quiniela Sports, no será responsable de las relaciones que surjan entre los usuarios derivadas del uso de su plataforma, las cuales serán responsabilidad única y exclusiva de aquellos, así como todos sus alcances legales.</p>

      <h2>14. Jurisdicción.</h2>
      <p>Para la interpretación y cumplimiento del presente acuerdo, y en el caso de controversia, ambas partes se someten a los Tribunales de la Ciudad de México, renunciando a cualquier fuero que pudiera corresponderles en razón de sus domicilios presentes o futuros.</p>

      <h2>15. Contacto</h2>
      <p>Si tiene alguna pregunta, comentario o inquietud relacionada con el servicio de Quiniela Sports o con el contenido de los presentes términos y condiciones, envíe un correo electrónico a info@bindiva.com.</p>
