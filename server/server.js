...
const authCheck = jwt({
    secret: jwks.expressJwtSecret({
        ...
        jwksUri: "https://chibi.auth0.com/.well-known/jwks.json"
    }),
    // This is the identifier we set when we created the API
    audience: 'quiniela-rusia',
    issuer: "https://chibi.auth0.com/",
    algorithms: ['RS256']
});
